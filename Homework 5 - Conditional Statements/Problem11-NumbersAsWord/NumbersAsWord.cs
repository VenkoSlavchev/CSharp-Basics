...
namespace Problem11_NumbersAsWord
{
    class NumbersAsWord
    {
        static void Main()
        {
            ...
            int undertwenty = number % 100;
            int tens = (number / 10) % 10;
            int lastdigit = number % 10;

            if (number < 0 || number > 999)
            {
                Console.WriteLine("Invalid number!Enter a number from [0...999] : ");
            }
            else
            {
                if (number == 0)
                ...
                else if (hundreds != 0 && tens == 0 && lastdigit == 0)
                {
                    switch (hundreds)
                    {
                ...
                if (undertwenty > 0 && undertwenty < 20)
                {
                    switch (undertwenty)
                    {
